...
static void _APPTEMP_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for APPTEMP Tasks. */
    xTaskCreate((TaskFunction_t) _APPTEMP_Tasks,
                "APPTEMP Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _APPTEMP_Tasks ( void )

  Summary:
    Maintains state machine of APPTEMP.
*/
